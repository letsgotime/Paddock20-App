  ...
  useEffect(() => {
    ...
    const onboardingSteps: OnboardingStep[] = [
      ...
      },
      {
        ...
        completed: profile.hasMaintenanceRecords || false,
        category: STEP_CATEGORIES.ADVANCED,
      ...
      // Premium Features (upsell opportunities)
      {
        ...
        completed: profile.hasDetailingPlan || false,
      ...
      },
      {
        ...
        completed: profile.hasAchievements || false,
        category: STEP_CATEGORIES.PREMIUM,
      ...
      },
      {
        ...
        completed: profile.hasViewedEvents || false,
        category: STEP_CATEGORIES.PREMIUM,
