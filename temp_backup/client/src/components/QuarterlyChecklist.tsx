...
const QuarterlyChecklist = () => {
  const [checklistItems, setChecklistItems] = useState([
    { id: 1, text: 'Full paint correction', checked: false },
    { id: 2, text: 'Apply ceramic coating', checked: false },
    { id: 3, text: 'Wheel removal and detailing', checked: false },
    { id: 4, text: 'Brake caliper cleaning', checked: false },
    { id: 5, text: 'Undercarriage inspection', checked: false },
    { id: 6, text: 'Full interior deep clean', checked: false },
    { id: 7, text: 'Leather rejuvenation treatment', checked: false },
    { id: 8, text: 'Comprehensive fluid check/change', checked: false }
  ]);
  ...
  return (
    <div className="apex-card mb-8">
      <div className="flex justify-between items-center mb-6">
        <h2 className="apex-header-green">Quarterly Reset</h2>
      ...
      <div className="mt-8 bg-gray-800 rounded-lg p-4">
        <h3 className="text-green-400 font-orbitron text-sm uppercase mb-2">Quarterly Treatment Details</h3>
        <textarea 
          className="w-full bg-gray-700 text-white rounded p-3 h-24"
          placeholder="Document ceramic coating brand, correction pad details, etc..."
        ></textarea>
      </div>
      
      <div className="flex justify-end mt-6">
        <button className="apex-button">
          Schedule Professional Detail
        </button>
      </div>
    </div>
  );
