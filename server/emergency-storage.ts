...
import { DEMO_MODE, getSessionStore } from './emergency-db';
...
class MockStorage implements IStorage {
  ...
  async createUserRoute(route: InsertUserRoute): Promise<UserRoute> { 
    return { 
      ...
      popularity: route.popularity || null,
      scenicRating: route.scenicRating || null,
      startLat: route.startLat || 0,
      startLon: route.startLon || 0,
      endLat: route.endLat || 0,
      endLon: route.endLon || 0,
      roadCondition: route.roadCondition || null,
      thumbnail: route.thumbnail || null,
      displayColor: route.displayColor || null
    } as UserRoute; 
  }
