...
const FixedSoundBar: React.FC = () => {
  ...
  return (
    <nav className="fixed bottom-0 left-0 right-0 flex items-center justify-between px-4 py-3 bg-black/95 backdrop-blur-lg border-t border-blue-900/50 shadow-[0_-5px_15px_rgba(0,0,0,0.3)] z-[999]">
      {/* GoTime Logo */}
      ...
      {/* Navigation Controls */}
      <div className="flex items-center mx-auto space-x-2 px-3 py-1 bg-black/80 rounded-full border border-blue-900/30">
        <button
          onClick={goBack}
          disabled={!canGoBack}
        ...
        <button
          onClick={goHome}
          className="w-8 h-8 flex items-center justify-center rounded-full text-blue-400 hover:bg-blue-900/30 hover:text-blue-300 active:bg-blue-900/50 active:scale-95 transition-all duration-200"
