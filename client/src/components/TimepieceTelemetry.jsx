...
import { 
  ...
  RotateCcw, CircleCheck, Bookmark, Compass, ZoomIn
} from 'lucide-react';
      ...
      {activeTab === 'overview' && (
        <div className="space-y-6">
          ...
          <div className="apex-card p-6">
            <div className="flex justify-between items-center mb-4">
              <div>
                <h3 className="font-orbitron text-lg text-amber-400 mb-1">Watch Movement Analytics</h3>
                <p className="text-gray-400 text-sm">Detailed mechanical performance metrics</p>
              </div>
              <div className="flex items-center gap-2">
                <div className="bg-amber-900/30 px-3 py-1 rounded text-sm text-amber-300 border border-amber-800/50 flex items-center">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <div className="bg-black/30 rounded-lg p-4 border border-gray-800">
                <div className="flex items-center justify-between mb-3">
                  <div className="text-amber-400 font-medium">Movement Precision</div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    <div className="flex justify-between text-xs text-gray-400 mb-1">
                      ...
                      <span className="text-amber-300">{timepiece.dailyRateVariation || "+/- 2 seconds/day"}</span>
                    </div>
                    <div className="w-full bg-gray-800 rounded-full h-2">
                      <div className="bg-amber-500 h-2 rounded-full" style={{width: `${getAccuracyScore()}%`}}></div>
                    </div>
                  </div>
                  ...
                  <div>
                    <div className="flex justify-between text-xs text-gray-400 mb-1">
                      ...
                      <span className="text-amber-300">0.2ms</span>
                    </div>
                    <div className="w-full bg-gray-800 rounded-full h-2">
                      <div className="bg-green-500 h-2 rounded-full" style={{width: "90%"}}></div>
                    </div>
                    <div className="mt-1 text-xs text-gray-500">Optimal: less than 0.5ms</div>
                  </div>
                  
                  <div>
                    <div className="flex justify-between text-xs text-gray-400 mb-1">
                      <span>Amplitude</span>
                      <span className="text-amber-300">295°</span>
                    </div>
                    <div className="w-full bg-gray-800 rounded-full h-2">
                      <div className="bg-blue-500 h-2 rounded-full" style={{width: "95%"}}></div>
                    </div>
                    <div className="mt-1 text-xs text-gray-500">Ideal range: 275-315°</div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/30 rounded-lg p-4 border border-gray-800">
                <div className="flex items-center justify-between mb-3">
                  <div className="text-amber-400 font-medium">Certification & Quality</div>
                </div>
                
                <div className="space-y-3">
                  <div className="flex items-center">
                    <div className="h-8 w-8 rounded-full bg-gray-800 flex items-center justify-center text-amber-400 mr-3">
                      <Award className="h-4 w-4" />
                    </div>
                    <div>
                      <div className="text-white font-medium">COSC Chronometer</div>
                      <div className="text-xs text-gray-400">Certificate #CH-28475-91</div>
                    </div>
                  </div>
                  
                  <div className="flex items-center">
                    <div className="h-8 w-8 rounded-full bg-gray-800 flex items-center justify-center text-green-400 mr-3">
                      <Shield className="h-4 w-4" />
                    </div>
                    <div>
                      <div className="text-white font-medium">Geneva Seal</div>
                      <div className="text-xs text-gray-400">Poinçon de Genève Certified</div>
                    </div>
                  </div>
                  
                  <div className="flex items-center">
                    <div className="h-8 w-8 rounded-full bg-gray-800 flex items-center justify-center text-blue-400 mr-3">
                      <CheckCircle className="h-4 w-4" />
                    </div>
                    <div>
                      <div className="text-white font-medium">Master Watchmaker</div>
                      <div className="text-xs text-gray-400">Final QC: Antoine Laurent</div>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-black/30 rounded-lg p-4 border border-gray-800">
                <div className="flex items-center justify-between mb-3">
                  <div className="text-amber-400 font-medium">Service Performance</div>
                </div>
                
                <div className="space-y-3">
                  <div>
                    <div className="text-white">Last Service Results</div>
                    <div className="text-xs text-gray-400 mb-2">
                      {timepiece.lastService ? new Date(timepiece.lastService).toLocaleDateString() : "No service data"}
                    </div>
                    
                    <div className="flex flex-wrap gap-2">
                      <span className="px-2 py-0.5 bg-green-900/30 text-green-400 text-xs rounded-full border border-green-800/50">
                        Movement: Excellent
                      </span>
                      <span className="px-2 py-0.5 bg-green-900/30 text-green-400 text-xs rounded-full border border-green-800/50">
                        Waterproofing: Passed
                      </span>
                  ...
                  <div className="pt-2">
                    <div className="text-white">Service Interval</div>
                    <div className="flex items-center gap-2 mt-1">
                      <div className="flex-1 bg-gray-800 h-2 rounded-full overflow-hidden">
                        <div 
                          className="bg-gradient-to-r from-green-500 via-yellow-500 to-red-500 h-full"
                          style={{width: `${timepiece.servicePercentage || 45}%`}}
                        ></div>
                      </div>
                      <div className="text-xs text-gray-400">
                        {timepiece.servicePercentage || 45}%
                      </div>
                    </div>
                    <div className="flex justify-between text-xs text-gray-500 mt-1">
                      <span>Last Service</span>
                      <span>Due {timepiece.nextServiceDue || "July 2026"}</span>
                    </div>
                  </div>
                </div>
              </div>
          ...
          <div className="apex-card p-6">
            <div className="flex justify-between items-center mb-4">
              <div>
                <h3 className="font-orbitron text-lg text-blue-400 mb-1">Market Value Analytics</h3>
                <p className="text-gray-400 text-sm">Historical performance and market position</p>
              </div>
              <div className="flex items-center gap-2">
                <div className="bg-blue-900/30 px-3 py-1 rounded text-sm text-blue-300 border border-blue-800/50 flex items-center">
            ...
            {/* Chart Area */}
            <div className="h-64 bg-black/30 rounded-lg border border-gray-800 p-4">
              {/* This would be a real chart in production */}
              <div className="h-full flex items-center justify-center">
                <div className="text-center">
                  <LineChart className="h-16 w-16 text-blue-500 mx-auto mb-2 opacity-50" />
                  <p className="text-blue-400">Value Appreciation: {timepiece.valueAppreciation || "+18.7%"}</p>
                  <p className="text-sm text-gray-400 mt-1">Historical CAGR: {timepiece.cagr || "9.3%"}</p>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mt-4">
              <div className="bg-black/30 rounded-lg p-3 border border-gray-800">
                <div className="text-gray-400 text-xs mb-1">Market Position</div>
                <div className="text-lg font-medium text-white">Top {timepiece.marketRarity || "5%"}</div>
                <div className="text-xs text-blue-400 mt-1">Limited Edition {timepiece.limitedEdition || "1 of 250"}</div>
              </div>
              
              <div className="bg-black/30 rounded-lg p-3 border border-gray-800">
                <div className="text-gray-400 text-xs mb-1">Original Retail</div>
                <div className="text-lg font-medium text-white">${timepiece.retailPrice?.toLocaleString() || "35,000"}</div>
                <div className="text-xs text-amber-400 mt-1">Current Premium: {timepiece.premium || "+28%"}</div>
              </div>
              
              <div className="bg-black/30 rounded-lg p-3 border border-gray-800">
                <div className="text-gray-400 text-xs mb-1">Auction Performance</div>
                <div className="text-lg font-medium text-white">${timepiece.auctionHigh?.toLocaleString() || "51,250"}</div>
                <div className="text-xs text-green-400 mt-1">Last Sold: {timepiece.lastAuction || "Phillips Dec 2024"}</div>
              </div>
            </div>
          </div>
