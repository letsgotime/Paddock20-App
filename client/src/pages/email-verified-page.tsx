...
const EmailVerifiedPage = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] bg-[url('/assets/images/backgrounds/ferrari-desert.png')] bg-repeat flex flex-col items-center justify-center px-4 py-12">
