      ...
      <div className="space-y-10">
        ...
        <section aria-labelledby="weather-heading">
          ...
          <div className="mt-3 text-center">
            <Link href="/weather-paddock" className="inline-flex items-center justify-center bg-blue-900/30 hover:bg-blue-900/50 text-blue-400 py-2 px-4 rounded-md text-sm transition-colors">
        ...
        <section aria-labelledby="features-heading">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="bg-gradient-to-r from-gray-900 to-black border border-gray-800 rounded-lg p-6 hover:shadow-lg hover:border-gray-700 transition-all">
              ...
              <Link href="/garage-vault" className="inline-flex items-center text-green-500 hover:text-green-400 font-medium">
                View Your Garage
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
            ...
            <div className="bg-gradient-to-r from-gray-900 to-black border border-gray-800 rounded-lg p-6 hover:shadow-lg hover:border-gray-700 transition-all">
              ...
              <Link href="/paddock20-vault" className="inline-flex items-center text-green-500 hover:text-green-400 font-medium">
                Enter The Vault
                <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4 ml-1" viewBox="0 0 20 20" fill="currentColor">
                  <path fillRule="evenodd" d="M10.293 5.293a1 1 0 011.414 0l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414-1.414L12.586 11H5a1 1 0 110-2h7.586l-2.293-2.293a1 1 0 010-1.414z" clipRule="evenodd" />
                </svg>
